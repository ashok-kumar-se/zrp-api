...
import com.example.stockservice.exception.response.Response;
...
public class GlobalExceptionHandlerController {
    ...
    public final ResponseEntity handleCustomException(HttpServletResponse res, CustomException ex) {
